...
// 데이터 receive 성공 유무 판단 !!
    ...
    public void setTb1Title() {
        ...
        tb1_t.setTextColor(Color.BLACK);
        tb1_t.setBackgroundColor(Color.GRAY);
        tr_ti.addView(tb1_t);
...
//        date.setPadding(5, 5, 5, 5);
//        tr_head.addView(date);
//        TextView kg = new TextView(getActivity());
//        kg.setText("Weight");
//        kg.setTextColor(Color.BLUE);
//        kg.setPadding(5, 5, 5, 5);
//        tr_head.addView(kg);
//        TextView age = new TextView(getActivity());
//        age.setText("Age");
//        age.setTextColor(Color.BLUE);
...
//
//        TextView dateView = new TextView(getActivity());
//        dateView.setText("178.5");
//        dateView.setPadding(5, 5, 5, 5);
//        TextView kgView = new TextView(getActivity());
//        kgView.setText("72.7");
//        kgView.setPadding(5, 5, 5, 5);
